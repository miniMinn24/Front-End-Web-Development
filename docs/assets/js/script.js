...
document.querySelector("#search-btn").onclick = (e) => {
	...
	// On Search click - automatically scroll back to products section
	if (isOpening) {
...
function addProductToCart(productBox) {
	...
	// generates product item in Cart Drawer
...
=========================== */
// On Submit click - clear registration form and displays success message
...
=========================== */
// After closing search - avoid toggling hidden items itself
...
searchInput.addEventListener("input", () => {
	const q = searchInput.value.toLowerCase();
	suggestionsBox.innerHTML = "";
	document.querySelector(".btn-showhide").style.display = "none";
...
document.querySelector("#search-btn").addEventListener("click", () => {
	...
	document.querySelector(".btn-showhide").style.display = "block";
});
...
// Safely close Order Success Modal
...
// Clear items in the Cart Drawer
function clearCart() {
...
// Cart item Remove/Quantify change
...
document.addEventListener("click", (e) => {
	...
	// (-Special Offers and Events) - Modal will not be displayed
...
document.addEventListener("click", (e) => {
	...
	// Special Offers - payment details and input in modal
...
// On payment submit click - process fake transaction
...
// Close actions
closeWelcomeModal.onclick = markVisitor;
skipWelcome.onclick = markVisitor;

// Email submit (Ofc, fake capture)
...
// Trigger on load
window.addEventListener("load", showWelcomeModalIfFirstVisit);
...
function initMap() {
	...
	const events = [
		// You can put events locations here (but haven't developed for this yet)
		{
	...
	// Bean Boutique Coffee Shop location (marker)
